...
const S = {
  ...
  cardFront: { backfaceVisibility:"hidden", background:T.color.surfaceLowest, border:"none", borderRadius:T.radius.xl, padding:"36px 28px", minHeight:260, display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center", boxShadow:T.shadow.card, position:"relative" },
  cardBack: { backfaceVisibility:"hidden", transform:"rotateY(180deg)", position:"absolute", top:0, left:0, right:0, background:T.color.surfaceLow, border:"none", borderRadius:T.radius.xl, padding:"36px 28px", minHeight:260, display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center", boxShadow:T.shadow.card },
  ...
  cardTextB: { fontSize:24, textAlign:"center", fontWeight:400, color:T.color.primary, lineHeight:1.3, padding:"0 12px", fontFamily:T.font.serif },
  ...
  cardActions: { display:"flex", gap:8, justifyContent:"center", marginTop:14 },
  cardActionBtn: { background:"transparent", border:"none", borderRadius:T.radius.md, padding:"6px 12px", fontSize:11, cursor:"pointer", color:T.color.onSurfaceVariant, fontFamily:T.font.sans, fontWeight:500 },
  cardActionBtnFlagged: { background:T.color.tertiaryFixed, color:T.color.onSecondaryContainer, cursor:"default", fontWeight:600 },
