...
//
// Suites that need no browser (logic, apply-splits, auth, dates, serving,
// progress, cahier-sync) run first
...
const NEEDS_BROWSER = (name) => !["logic", "apply-splits", "auth", "dates", "serving", "progress", "cahier-sync", "grammar-sort", "instructions", "adaptive"].includes(name);
